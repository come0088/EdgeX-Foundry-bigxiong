...
./configure --host=arm-linux --build=amd64-linux --target=arm --prefix=/usr/ CC=arm-linux-gnueabihf-gcc  --without-zlib  --without-python
...
echo "CMAKE_EXE_LINKER_FLAGS:STRING= -L /usr/lib -lxml2 -L /usr/lib -lz -pthread" > CMakeCache.txt
